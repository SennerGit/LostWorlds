...
public class ElvesEntity extends AbstractVillager implements ReputationEventHandler, VillagerDataHolder {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(ElvesEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
            SynchedEntityData.defineId(ElvesEntity.class, EntityDataSerializers.INT);
    ...
    public ElvesEntity(EntityType<? extends AbstractVillager> pEntityType, Level pLevel) {
...
//    public ElvesVariant getVariant() {
//        return ElvesVariant.byId(this.getTypeVariant() & 255);
//    }
    ...
    public void setVariant(ElvesVariant variant) {
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData, @Nullable CompoundTag pDataTag) {
        ElvesVariant variant = Util.getRandom(ElvesVariant.values(), this.random);
