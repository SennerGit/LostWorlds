...
public class CreativeScreenEvents {
    private static final ResourceLocation ICONS = LostWorldsApi.modLoc("textures/gui/creative_tab_icons.png");
    ...
    private void compileItems()
    {
        ...
        ForgeRegistries.ITEMS.getValues().stream()
                .filter(item -> Objects.requireNonNull(ForgeRegistries.ITEMS.getKey(item)).getNamespace().equals(LostWorldsApi.MODID))
                .forEach(item -> {
