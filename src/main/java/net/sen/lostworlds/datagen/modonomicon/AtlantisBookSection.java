...
public class AtlantisBookSection {
    public static BookCategoryModel makeAtlantisBookCategory(BookContextHelper context) {
        context.category("atlantis");
//        this.lang().add(context().categoryName(), "Getting Started");
        ...
        return BookCategoryModel.create(modLoc(context.categoryId()), context.categoryName())
                .withIcon(ModBlocks.ATLANTIS_PORTAL_FRAME.getId().toString())
                .withEntries(
                        introEntry
                );
    }
