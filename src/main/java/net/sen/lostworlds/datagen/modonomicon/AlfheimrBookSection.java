...
public class AlfheimrBookSection {
    public static BookCategoryModel makeAlfheimrBookCategory(BookContextHelper context) {
        context.category("alfheimr");
//        this.lang().add(context().categoryName(), "Getting Started");
        ...
        return BookCategoryModel.create(LostWorldsConstants.modLoc(context.categoryId()), context.categoryName())
                .withIcon(ModBlocks.ALFHEIMR_PORTAL_FRAME.getId().toString())
                .withEntries(
                        introEntry
                );
    }
