...
public class SeahorseModel<T extends SeahorseEntity> extends HierarchicalModel<T> {
	...
	private void applyHeadRotation(SeahorseEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
