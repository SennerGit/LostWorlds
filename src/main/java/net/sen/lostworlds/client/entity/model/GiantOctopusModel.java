...
public class GiantOctopusModel<T extends GiantOctopusEntity> extends HierarchicalModel<T> {
	...
	public GiantOctopusModel(ModelPart root) {
	...
	@Override
	public void setupAnim(GiantOctopusEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(GiantOctopusEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
