...
public class MorayEelsModel<T extends MorayEelsEntity> extends HierarchicalModel<T> {
	...
	public MorayEelsModel(ModelPart root) {
	...
	@Override
	public void setupAnim(MorayEelsEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(MorayEelsEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
