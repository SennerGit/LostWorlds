...
public class VampireBatModel<T extends VampireBatEntity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(LostWorldsApi.modLoc("vampire_bat_model"), "main");
	private final ModelPart vampire_bat;
	private final ModelPart head;

	public VampireBatModel(ModelPart root) {
		this.vampire_bat = root.getChild("vampire_bat");
		this.head = vampire_bat.getChild("body").getChild("torso").getChild("head");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition vampire_bat = partdefinition.addOrReplaceChild("vampire_bat", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 2.5F));

		PartDefinition body = vampire_bat.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
...
//		this.animateWalk(ModVampireBatAnimationDefinitions.RHINO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
//		this.animate(entity.idleAnimationState, ModVampireBatAnimationDefinitions.RHINO_IDLE, ageInTicks, 1f);
//		this.animate(entity.attackAnimationState, ModVampireBatAnimationDefinitions.RHINO_ATTACK, ageInTicks, 1f);
//		this.animate(entity.sitAnimationState, ModVampireBatAnimationDefinitions.RHINO_SIT, ageInTicks, 1f);
	}

	private void applyHeadRotation(VampireBatEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
