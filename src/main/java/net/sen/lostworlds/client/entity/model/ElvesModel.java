...
public class ElvesModel<T extends ElvesEntity> extends HierarchicalModel<T> {
	...
	public ElvesModel(ModelPart root) {
	...
	@Override
	public void setupAnim(ElvesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(ElvesEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
