...
public class MerfolkModel<T extends MerfolkEntity> extends HierarchicalModel<T> {
	...
	@Override
	public void setupAnim(MerfolkEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(MerfolkEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
