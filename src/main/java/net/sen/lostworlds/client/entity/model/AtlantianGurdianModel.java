...
public class AtlantianGurdianModel<T extends AtlantianGurdianEntity> extends HierarchicalModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(LostWorldsApi.modLoc("rhino_model"), "main");
	private final ModelPart rhino;
	private final ModelPart head;

	public AtlantianGurdianModel(ModelPart root) {
	...
	@Override
	public void setupAnim(AtlantianGurdianEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(AtlantianGurdianEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
