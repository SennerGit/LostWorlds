...
public class AtlantianModel<T extends AtlantianEntity> extends HierarchicalModel<T> {
	...
	public AtlantianModel(ModelPart root) {
	...
	@Override
	public void setupAnim(AtlantianEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(AtlantianEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
