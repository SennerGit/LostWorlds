...
public class ElectricEelsModel<T extends ElectricEelsEntity> extends HierarchicalModel<T> {
	...
	public ElectricEelsModel(ModelPart root) {
	...
	@Override
	public void setupAnim(ElectricEelsEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(ElectricEelsEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
