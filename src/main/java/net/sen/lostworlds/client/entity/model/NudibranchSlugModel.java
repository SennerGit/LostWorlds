...
public class NudibranchSlugModel<T extends NudibranchSlugEntity> extends HierarchicalModel<T> {
	...
	public NudibranchSlugModel(ModelPart root) {
	...
	@Override
	public void setupAnim(NudibranchSlugEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(NudibranchSlugEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
