...
public class DwarvesModel<T extends DwarvesEntity> extends HierarchicalModel<T> {
	...
	public DwarvesModel(ModelPart root) {
	...
	@Override
	public void setupAnim(DwarvesEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	private void applyHeadRotation(DwarvesEntity entity, float netHeadYaw, float headPitch, float ageInTicks) {
