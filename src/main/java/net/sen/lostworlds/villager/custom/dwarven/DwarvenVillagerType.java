...
public final class DwarvenVillagerType {
//    public static final DwarvenVillagerType DESERT = register("desert");
//    public static final DwarvenVillagerType JUNGLE = register("jungle");
//    public static final DwarvenVillagerType PLAINS = register("plains");
//    public static final DwarvenVillagerType SAVANNA = register("savanna");
//    public static final DwarvenVillagerType SNOW = register("snow");
//    public static final DwarvenVillagerType SWAMP = register("swamp");
//    public static final DwarvenVillagerType TAIGA = register("taiga");
    private final String name;
    private static final Map<ResourceKey<Biome>, DwarvenVillagerType> BY_BIOME = Util.make(Maps.newHashMap(), (p_35834_) -> {
...
//        p_35834_.put(Biomes.WINDSWEPT_FOREST, TAIGA);
    ...
    public DwarvenVillagerType(String pName) {
        this.name = pName;
    }
...
//    private static DwarvenVillagerType register(String pKey) {
//        return Registry.register(BuiltInRegistries.VILLAGER_TYPE, new ResourceLocation(pKey), new DwarvenVillagerType(pKey));
//    }

//    public static DwarvenVillagerType byBiome(Holder<Biome> pBiome) {
