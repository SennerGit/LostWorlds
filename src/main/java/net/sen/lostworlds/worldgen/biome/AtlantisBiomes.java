...
public class AtlantisBiomes {
    ...
    */
    ...
    public static MobSpawnSettings.Builder defaultMobSpawning() {
        ...
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.SHARK.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.MERFOLK.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.ATLANTIAN.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.ATLANTIAN_GURDIAN.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.ELECTRIC_EELS.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.GIANT_OCTOPUS.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.GIANT_SQUID.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.GREAT_WHITE.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.JELLYFISH.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.MORAY_EELS.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.RAY.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.NUDIBRANCH_SLUG.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.SEAHORSE.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.SIREN.get(), 25, 8, 8));
        spawnInfo.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(ModEntities.ANGLER_FISH.get(), 25, 8, 8));

        spawnInfo.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(ModEntities.CLOWNFISH.get(), 25, 8, 8));
