...
public class WeaverTrunkPlacer extends TrunkPlacer {
    public static final Codec<WeaverTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, WeaverTrunkPlacer::new));

    public WeaverTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.WEAVER_TRUNK_PLACER.get();
    }
