...
public class SacredTreeTrunkPlacer extends TrunkPlacer {
    public static final Codec<SacredTreeTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, SacredTreeTrunkPlacer::new));

    public SacredTreeTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.SACRED_TREE_TRUNK_PLACER.get();
    }
