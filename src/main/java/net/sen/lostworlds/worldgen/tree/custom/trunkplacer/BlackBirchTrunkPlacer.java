...
public class BlackBirchTrunkPlacer extends TrunkPlacer {
    public static final Codec<BlackBirchTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, BlackBirchTrunkPlacer::new));

    public BlackBirchTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.BLACK_BIRCH_TRUNK_PLACER.get();
    }
