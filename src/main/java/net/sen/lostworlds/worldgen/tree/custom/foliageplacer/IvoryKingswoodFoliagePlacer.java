...
public class IvoryKingswoodFoliagePlacer extends FoliagePlacer {
    public static final Codec<IvoryKingswoodFoliagePlacer> CODEC = RecordCodecBuilder.create((instance) -> foliagePlacerParts(instance)
                    .and(IntProvider.codec(0, 16).fieldOf("trunk_height").forGetter((placer) -> placer.trunk_height))
                    .apply(instance, IvoryKingswoodFoliagePlacer::new));

    private final IntProvider trunk_height;

    public IvoryKingswoodFoliagePlacer(IntProvider pRadius, IntProvider pOffset, IntProvider height) {
    ...
    protected FoliagePlacerType<?> type() {
        return ModFoliagePlacerTypes.IVORY_KINGSWOOD_FOLIAGE_PLACER.get();
    }
