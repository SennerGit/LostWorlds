...
public class WhiteOakTrunkPlacer extends TrunkPlacer {
    public static final Codec<WhiteOakTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, WhiteOakTrunkPlacer::new));

    public WhiteOakTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.WHITE_OAK_TRUNK_PLACER.get();
    }
