...
public class BranchingTrunkPlacer extends TrunkPlacer {
    ...
    public BranchingTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB, int branchDownwardOffset, BranchesConfig branchesConfig, boolean perpendicularBranches) {
    ...
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.TRUNK_BRANCHING.get();
    }
