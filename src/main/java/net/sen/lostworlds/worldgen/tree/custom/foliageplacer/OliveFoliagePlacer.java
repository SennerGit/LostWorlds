...
public class OliveFoliagePlacer extends FoliagePlacer {
    public static final Codec<OliveFoliagePlacer> CODEC = RecordCodecBuilder.create((instance) -> foliagePlacerParts(instance)
    ...
    public OliveFoliagePlacer(IntProvider pRadius, IntProvider pOffset, IntProvider height) {
