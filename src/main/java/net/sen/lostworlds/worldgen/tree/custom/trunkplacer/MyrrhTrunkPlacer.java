...
public class MyrrhTrunkPlacer extends TrunkPlacer {
    public static final Codec<MyrrhTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, MyrrhTrunkPlacer::new));

    public MyrrhTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.MYRRH_TRUNK_PLACER.get();
    }
