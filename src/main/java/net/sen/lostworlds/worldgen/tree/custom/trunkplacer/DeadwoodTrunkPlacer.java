...
public class DeadwoodTrunkPlacer extends TrunkPlacer {
    public static final Codec<DeadwoodTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, DeadwoodTrunkPlacer::new));

    public DeadwoodTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.DEADWOOD_TRUNK_PLACER.get();
    }
