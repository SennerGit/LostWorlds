...
public class IvoryKingswoodTrunkPlacer extends TrunkPlacer {
    public static final Codec<IvoryKingswoodTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, IvoryKingswoodTrunkPlacer::new));

    public IvoryKingswoodTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.IVORY_KINGSWOOD_TRUNK_PLACER.get();
    }
