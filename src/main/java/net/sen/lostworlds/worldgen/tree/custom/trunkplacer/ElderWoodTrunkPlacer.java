...
public class ElderWoodTrunkPlacer extends TrunkPlacer {
    public static final Codec<ElderWoodTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, ElderWoodTrunkPlacer::new));

    public ElderWoodTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.ELDER_WOOD_TRUNK_PLACER.get();
    }
