...
public class LaurelTrunkPlacer extends TrunkPlacer {
    public static final Codec<LaurelTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, LaurelTrunkPlacer::new));

    public LaurelTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.LAUREL_TRUNK_PLACER.get();
    }
