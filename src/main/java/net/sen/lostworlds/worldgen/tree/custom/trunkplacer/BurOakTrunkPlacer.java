...
public class BurOakTrunkPlacer extends TrunkPlacer {
    public static final Codec<BurOakTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, BurOakTrunkPlacer::new));

    public BurOakTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.BUR_OAK_TRUNK_PLACER.get();
    }
