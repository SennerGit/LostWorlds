...
public class CypressFoliagePlacer extends FoliagePlacer {
    public static final Codec<CypressFoliagePlacer> CODEC = RecordCodecBuilder.create((instance) -> foliagePlacerParts(instance)
    ...
    public CypressFoliagePlacer(IntProvider pRadius, IntProvider pOffset, IntProvider height) {
