...
public class EbonyKingswoodTrunkPlacer extends TrunkPlacer {
    public static final Codec<EbonyKingswoodTrunkPlacer> CODEC = RecordCodecBuilder.create(instance ->
            trunkPlacerParts(instance).apply(instance, EbonyKingswoodTrunkPlacer::new));

    public EbonyKingswoodTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) {
        super(pBaseHeight, pHeightRandA, pHeightRandB);
    }

    @Override
    protected TrunkPlacerType<?> type() {
        return ModTrunkPlacerTypes.EBONY_KINGSWOOD_TRUNK_PLACER.get();
    }
