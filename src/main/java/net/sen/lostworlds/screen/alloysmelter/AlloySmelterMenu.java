...
public class AlloySmelterMenu extends AbstractContainerMenu {
    ...
    public int getScaledBurnProgress() {
        int progress = this.data.get(0);
        int maxProgress = this.data.get(1);  // Max Progress
        int progressFireSize = 14; // This is the height in pixels of your Fire
    ...
    private static final int VANILLA_FIRST_SLOT_INDEX = INPUT_1_SLOT.getSlotId();
    private static final int VANILLA_SECOND_SLOT_INDEX = INPUT_2_SLOT.getSlotId();
