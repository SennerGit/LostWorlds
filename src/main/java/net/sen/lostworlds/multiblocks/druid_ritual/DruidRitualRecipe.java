...
//
//public class DruidRitualRecipe implements Recipe<Container> {
...
//    private final Supplier<DruidRitual> druidRitual;
...
//
//    public DruidRitualRecipe(ResourceLocation id, ResourceLocation pentacleId, ResourceLocation ritualType, ItemStack ritualDummy,
...
//        this.druidRitual = () -> ModDruidRituals.REGISTRY.get().getValue(this.ritualType).create(this);
...
//        return this.druidRitual.get().identify(level, goldenBowlPosition, activationItem);
//    }
//
//    @Override
//    public RecipeType<?> getType() {
//        return ModRecipes.DRUID_RITUAL_TYPE.get();
//    }
//
...
//    }
//
//    public DruidRitual getDruidRitual() {
//        return this.druidRitual.get();
//    }
//
...
//    }
//
//    public static class Serializer implements RecipeSerializer<DruidRitualRecipe> {
...
//
//        @Override
//        public DruidRitualRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
...
//
//            return new DruidRitualRecipe(recipeId, pentacleId, ritualType, ritualDummy,
...
//
//        @Override
//        public DruidRitualRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
...
//
//            return new DruidRitualRecipe(recipeId, pentacleId, ritualType, ritualDummy, result, entityToSummon, entityNbt,
...
//
//        @Override
//        public void toNetwork(FriendlyByteBuf buffer, DruidRitualRecipe recipe) {
